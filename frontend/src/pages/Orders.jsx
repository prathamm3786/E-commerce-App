    ...
    <div className="border-t pt-16 border-gray-200">
      ...
      <div className="">{
        orderData.map((item, index) => (
          <div className="py-4 border-t border-b border-gray-200 text-gray-700 flex flex-col md:flex-row md:items-center md:justify-between gap-4" key={index}>
